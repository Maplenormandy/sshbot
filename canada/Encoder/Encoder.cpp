...
uint8_t Encoder::attach(uint8_t inPinA, uint8_t inPinB)
{
  ...
  switch (index)
  {
    ...
    case 0:
      attachInterrupt(interruptNumber, Encoder::service0, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 1
    case 1:
      attachInterrupt(interruptNumber, Encoder::service1, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 2
    case 2:
      attachInterrupt(interruptNumber, Encoder::service2, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 3
    case 3:
      attachInterrupt(interruptNumber, Encoder::service3, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 4
    case 4:
      attachInterrupt(interruptNumber, Encoder::service4, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 5
    case 5:
      attachInterrupt(interruptNumber, Encoder::service5, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 6
    case 6:
      attachInterrupt(interruptNumber, Encoder::service6, CHANGE);
      break;
#endif
#if NUM_EXTERNAL_INTERRUPTS > 7
    case 7:
      attachInterrupt(interruptNumber, Encoder::service7, CHANGE);
      break;
#endif
  }
